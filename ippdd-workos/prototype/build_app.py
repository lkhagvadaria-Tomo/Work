...
seed = {
    ...
    "users": [
        ...
        {"id": "OB", "name": "Өлзийбаяр", "email": "", "role": "Захирал", "dept": "ISCMD"},
...
<div id="login" hidden>
  ...
  <div class="login-side"><div class="login-card">
    ...
    <div class="acct-box">
      ...
      <div id="acctList"></div>
      <div class="picker-note">Прототип нэвтрэлт: эрхийн хяналт хөтөч талд. Идэвхгүй 20 минутын
      дараа автоматаар гарна. Шинэ газар/хэрэглэгчийг захирал «Админ» хэсгээс нэмнэ.</div>
    </div>
